...
#define DEFINE_VEC(T) \
    ...
    \
    T vec_##T##_get(vec_##T *v, size_t i) { \
        if (i >= v->len) { \
    ...
    \
    void vec_##T##_set(vec_##T *v, size_t i, T item) { \
        if (i >= v->len) { \
    ...
    \
    void vec_##T##_insert(vec_##T *v, size_t i, T item) { \
        if (i > v->len) { \
            printf("Index out of bounds\n"); \
            return; \
        } \
    ...
    \
    void vec_##T##_remove(vec_##T *v, size_t i) { \
        if (i >= v->len) { \
            printf("Index out of bounds\n"); \
            return; \
        } \
